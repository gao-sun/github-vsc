// extracted from https://github.com/akamud/vscode-theme-onedark/blob/master/themes/OneDark.json
...
export default {
  ...
  tokenColors: [
    ...
    {
      name:
        'Source Elixir Constant Language,source Elixir Constant Numeric,source Elixir Constant Definition',
      scope: [
    ...
    {
      name:
        'Source Elixir Keyword Special Method,source Elixir Embedded Section,source Elixir Embedded Source Empty',
      scope: [
